...
public class KQLTest {
    ...
    public void customersingermany() throws IOException {
        ...
        InputStream q = KQLTest.class.getResourceAsStream("/ai/koryki/northwind/demo/customersingermany.kql");
    ...
    public void complex1() throws IOException {
        ...
        InputStream q = KQLTest.class.getResourceAsStream("/ai/koryki/northwind/kql/complex/complex1.kql");
    ...
    public void suppliersandproductsincategory() throws IOException {
        ...
        InputStream q = KQLTest.class.getResourceAsStream("/ai/koryki/northwind/demo/suppliersandproductsincategory.kql");
    ...
    public void customersmorethan10orders() throws IOException {
        ...
        InputStream q = KQLTest.class.getResourceAsStream("/ai/koryki/northwind/kql/customersmorethan10orders.kql");
